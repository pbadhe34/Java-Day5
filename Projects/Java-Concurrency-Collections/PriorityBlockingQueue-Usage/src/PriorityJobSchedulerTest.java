...
public class PriorityJobSchedulerTest {
    ...
    public static void main(String[] args) throws InterruptedException {
    	...
    	whenMultiplePriorityJobsQueued_thenHighestPriorityJobIsPicked();
    }
    public static void whenMultiplePriorityJobsQueued_thenHighestPriorityJobIsPicked() {
        ...
        // delay to avoid job sleep .. being interrupted
        try {
            Thread.sleep(2000);
