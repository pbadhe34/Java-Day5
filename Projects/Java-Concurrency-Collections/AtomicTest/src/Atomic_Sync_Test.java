	...
	public class Atomic_Sync_Test {
	  ...
	  public static void main(String[] args) {
	    ...
	    doTest(new SynchronizedRunnable());
	   ...
	   /* nLoops = Integer.parseInt(args[0]);
	    ...
	    System.out.println("Starting synchrnized test");
	    cleanGC();
	    Timestamp syncTS = new Timestamp();
	    doTest(new SynchronizedRunnable());
	    syncTS.stop();
	    System.out.println("Local synchronized took " + syncTS);
